# machining-and-data-science     Complete Machine Learning and Data Science: Zero to Mastery (2020)
Table of Contents
...
Structured Data - from relational Database
Semi-Structured Data - eg. XML, CSV, JSON
UnStructured Data - eg. pdf, email, document
...
OLTP vs OLAP OLTP - SQL database, relational database, transactional OLAP - use for analytical purpose
...
Storm
Kineses
Data -> Ingest data through Kafka -> Real time stream processing Data -> Ingest data through Kafka -> Batch processing
...
Turn our (a jpg) into Tensorsimage
Normalize our image (convert color channel values from from 0-255 to 0-1).
Resize the to be a shape of (224, 224)image
...
TensorFlow Hub Papers With Code PyTouch Hub Model Zoo TensorFlow Keras
...
# Setup model URL from TensorFlow Hub
MODEL_URL = "https://tfhub.dev/google/imagenet/mobilenet_v2_130_224/classification/4"
A Comprehensive Guide to Convolutional Neural Networks — the ELI5 way Review: MobileNetV2 — Light Weight Model (Image Classification) How to Choose Loss Functions When Training Deep Learning Neural Networks TensorFlow Metrics
...
Create a TensorBoard callback which is able to save logs to a directory and pass it to our model's function. fit()✅
Visualize our models training logs with the magic function (we'll do this after model training).%tensorboard
...
Now you’ve got skills, what do you do next? The most important question you can ask
...
Start the job before you have it The weekend project principle
...
Storytelling
What story are you trying to tell? Always ask, Who’s it for?

“Who’s it for?”
“What do they need to know?” = Specific = Courage Write it down
What did you work on today?
What are you working this week? Progress, not perfection
...
devblog
Devblog: How to Launch Your Own Developer Blog on Your Own Domain in Minutes
⬆ back to top
